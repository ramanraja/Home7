...
class AlexaResponse:
    ...
    def create_payload_endpoint  (self, **kwargs):
        ...
        endpoint = {
            ...
            'description': kwargs.get('description', 'Intof IoT Endpoint'),
            ...
            'friendlyName': kwargs.get('friendly_name', 'Smart Switch'),
            'manufacturerName': kwargs.get('manufacturer_name', 'Intof Smart Homes Ltd')
        }
        if 'cookie' in kwargs:
    ...
    def create_payload_endpoint_capability(self, **kwargs):
        ...
        if supported:
            ...
            capability['properties']['retrievable'] = kwargs.get('retrievable', False)  # TODO: study and set this to true
        return capability
