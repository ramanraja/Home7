...
class UserMap ():
    ...
    def token_amazon_map (self, token):
        ...
        #print (type(amazonid))  # it is json-as-a-string 
    ...
    # STUB *    
    def save_grant (self, intofid, grant_code, grantee_token):
        print ('UserMap: THIS IS A STUB to save grant code and token !')
        print ('Record: {} -> {}, {}'.format(intof_id, grant_code, grantee_toekn))
    ...
    def add_test_data (self):
        ...
        usr4 = {'amazonid' : 'amzn1.account.AAAAAAADDDDDD', 'intofid' : 'INTOF-id-999-VR', 'grant_code' : 'this-is-sample-grant-code4', 'grant_token' : 'this-is-sample-grant-token-4'}
        usr5 = {'amazonid' : 'amzn1.account.BBBBBBBCCCCCC', 'intofid' : 'INTOF-id-888-MR', 'grant_code' : 'this-is-sample-grant-code5', 'grant_token' : 'this-is-sample-grant-token-5'}
        usr6 = {'amazonid' : 'amzn1.account.xxxyyywwwwqqq', 'intofid' : 'INTOF-id-777-NR', 'grant_code' : 'this-is-sample-grant-code6', 'grant_token' : 'this-is-sample-grant-token-6'}
        usr7 = {'amazonid' : 'amzn1.account.zzzzzwwwwvvvv', 'intofid' : 'INTOF-id-666-VK', 'grant_code' : 'this-is-sample-grant-code7', 'grant_token' : 'this-is-sample-grant-token-7'}
        self.table.insert (usr1)
        self.table.insert (usr2)
        self.table.insert (usr3)
        self.table.insert (usr4)
        self.table.insert (usr5)
        self.table.insert (usr6)
        self.table.insert (usr7)        
...
if (__name__ == '__main__'): 
    ...
    # Say 'Alexa, WASHING MACHINE ON' and then copy this token from Cloud Watch logs
    token = "Atza|Iw.v0L..........ORYdHEtocMw"
