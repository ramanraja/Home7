...
# Keep this in sync with the RelsenMap class on the Alexa discovery lambda; they are the same code.
...
class RelsenMap ():
    ...
    # get only endpoint and friendly name for a given user id
    # The table has one-to-many mapping: for each intofid there are a number of relsens
