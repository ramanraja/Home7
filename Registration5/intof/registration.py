...
class UserRegistration ():
    ...
    def create_user (self, user): 
        ...
        name = user.get('name', 'NO-NAME')  # TODO: check these for validity!
    ...
    def create_intof_id (self):
        r = randint(1000,100000)   # TODO: implement this fully; de-duplicate
        iid = 'IN-' +str(r)
        return (iid)
    ...
    def add_test_data (self):
        ...
        usr4 = {'intofid' : test_ids[5], 'email' : 'jpp@pulu.com', 'name' : 'Jala pino', 'passhash' : 'XX6996XX6996'}        
