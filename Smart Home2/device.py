...
class Device ():
    ...
    def add_test_data (self):
        ...
        dev6 = {'intofid' : 'INTOF-id-999', 'endpoint':'intof_856CD8.POWER1', 'fname':'room heater'}
        dev7 = {'intofid' : 'INTOF-id-999', 'endpoint':'intof_856CD8.POWER2', 'fname':'fridge'}
        dev8 = {'intofid' : 'INTOF-id-999', 'endpoint':'intof_856CD8.POWER3', 'fname':'washing machine'}
        dev9 = {'intofid' : 'INTOF-id-999', 'endpoint':'intof_856CD8.POWER4', 'fname':'kitchen light'}        
        ...
        self.table.insert (dev7)    
        self.table.insert (dev8)
        self.table.insert (dev9)          
        print ('9 test devices added.')
...
if (__name__ == '__main__'): 
    ...
    devs = device.get_devices ('INTOF-id-999')
    print (devs)
    print (len(devs), ' relays.')    
    print()  
