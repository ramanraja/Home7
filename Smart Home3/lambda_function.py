# Alexa enabled Smart Home. Supported by an OEM Cloud & device database.
...
def handle_discovery (request):
    ...
    if (intof_id == None):
        response = get_error_response ('REGISTRATION_ERROR', 'Unable to get the Intof user id.')    
...
def save_grant (grant_code, grantee_token):     # TODO: implement this !
    grant_record = {
      ...
      "gcode" : grant_code, 
      "gtoken" : grantee_token
    }
    # TODO: save it in UserMap table
    print ('-  This is a stub; saving grants to be implemented')
    return True
...
def lambda_handler(request, context):
    ...
    database_url = 'mysql://user:password@100.101.102.103:3306/customers'   
    try:
...
PowerState:
{
  "directive": {
    ...
    "endpoint": {
      "endpointId": "INTOF_29AF09.POWER1"
    }
  }
}
--------------------------
